#ifndef FACE_APP_SHARED_PLUGIN_NORMAL_DETERMINANT_VIS_H
#define FACE_APP_SHARED_PLUGIN_NORMAL_DETERMINANT_VIS_H
...
class plugins_3dfast_curvature_EXPORT NormalDeterminant : public FaceTools::VisualisationAction
{ Q_OBJECT
public:
    NormalDeterminant();

    const QIcon* getIcon() const override { return &_icon;}
    QString getDisplayName() const override { return "Determinant";}
