#ifndef FACE_APP_SHARED_PLUGIN_MAX_CURVATURE_VIS_H
#define FACE_APP_SHARED_PLUGIN_MAX_CURVATURE_VIS_H
...
class plugins_3dfast_curvature_EXPORT MaxCurvature : public FaceTools::VisualisationAction
{
Q_OBJECT
public:
    MaxCurvature();
    ...
    QString getDisplayName() const override { return "kp1 Curvature";}
