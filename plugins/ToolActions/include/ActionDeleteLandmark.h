#ifndef FACE_APP_ACTION_DELETE_LANDMARK_H
#define FACE_APP_ACTION_DELETE_LANDMARK_H

#include <FaceActionInterface.h>

namespace FaceApp {

class ActionDeleteLandmark : public FaceTools::FaceAction
{ Q_OBJECT
public:
    ActionDeleteLandmark( const std::string& dname, const std::string& iconfilename="");
