#ifndef FACE_APP_SHARED_PLUGIN_MEAN_CURVATURE_VIS_H
#define FACE_APP_SHARED_PLUGIN_MEAN_CURVATURE_VIS_H
...
class plugins_3dfast_curvature_EXPORT MeanCurvature : public FaceTools::VisualisationAction
{ Q_OBJECT
public:
    MeanCurvature();

    const QIcon* getIcon() const override { return &_icon;}
    QString getDisplayName() const override { return "Mean Curvature";}
